...
<div class="row">
                    ...
                    <div class="table-responsive table-sales">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="flag">
                                    <img src="{{asset('public/img/flags/BR.png')}}"> </div>
                                </td>
                                <td>Brasil</td>
    ...
    <div class="row">
        ...
        <div class="card card-product">
            ...
            <a href="#pablo">
                <img class="img" src="{{asset('public/img/card-2.jpg')}}">
            </a>
            </div>
            <div class="card-body">
        ...
        <div class="card card-product">
            <div class="card-header card-header-image" data-header-animation="true">
            <a href="#pablo">
                <img class="img" src="{{asset('public/img/card-3.jpg')}}">
            </a>
            </div>
            <div class="card-body">
            <div class="card-actions text-center">
        ...
        <div class="card card-product">
            <div class="card-header card-header-image" data-header-animation="true">
            <a href="#pablo">
                <img class="img" src="{{asset('public/img/card-1.jpg')}}">
            </a>
            </div>
            <div class="card-body">
            <div class="card-actions text-center">
